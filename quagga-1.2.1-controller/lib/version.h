...
#define QUAGGA_CONFIG_ARGS "--enable-vtysh --enable-user=root --enable-group=root --enable-vty-group=root --prefix=/usr --sysconfdir=/etc/quagga --localstatedir=/var/run/quagga"
